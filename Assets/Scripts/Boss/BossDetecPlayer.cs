...
public class BossDetecPlayer : MonoBehaviour
{
    ...
    [SerializeField] private bool m_IsPlayerInFront;
    [SerializeField] private bool m_BossIsAttacked;
    ...
    private void CheckPlayerPosition()
    {
        ...
        {
            m_IsPlayerInFront = false;
        }
    }

    public void FlipWhenAttacked()
    {
        m_BossIsAttacked = true;
        if(m_BossIsAttacked && !m_IsPlayerInFront)
        {
